# Tomato defect detection dataset (freshness) with 6000 images supports yolo format

# Body

Tomato Defect (Freshness) Detection Dataset, 6000 Images, Supports Yolo Format, Clearly Labeled, Rich in Image Content, Suitable for Projects Related to Tomato Freshness and Defect Detection.


Note
freshly fresh, freshness
rotten rotten, rotting
